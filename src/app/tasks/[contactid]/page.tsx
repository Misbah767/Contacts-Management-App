...
export default function TasksPage() {
  ...
  const { byContact, createTask, toggleTask, deleteTask, updateTask } =
    useTasks();
  ...
  // Show loader while contacts or tasks are loading
  if (contactsLoading) {
    return (
  ...
  return (
    <div className="w-full min-h-screen bg-[#f9fafb] p-6 flex flex-col items-center">
      <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg p-6 space-y-4">
        ...
        {/* Add Task Button to open DueDateModal */}
        <AddTaskButton
          contactId={contactId}
          onAddTask={(data) => {
